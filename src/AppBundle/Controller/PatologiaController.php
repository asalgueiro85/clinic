...
class PatologiaController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('patologia', array('id' => $entity->getId())));
        }
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('patologia', array('id' => $id)));
        }
     ...
     * @Route("/{id}/eliminar", name="patologia_delete")
     */
