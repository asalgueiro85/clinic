...
use AppBundle\Form\ContactosType;
...
class ContactosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Contactos')->findAll();
     ...
     * @Method("POST")
     * @Template("AppBundle:Contactos:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Contactos')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Contactos:edit.html.twig")
     */
