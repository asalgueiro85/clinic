 ...
 * TipoIdentificacion
 *
 * @ORM\Table(name="tipoIdentificaciones")
 * @ORM\Entity(repositoryClass="AppBundle\Entity\TipoIdentificacionRepository")
 */
class TipoIdentificacion
{
     ...
     * @var integer
     *
     * @ORM\Column(name="id_tipoIdentificacion", type="integer")
     * @ORM\Id
    ...
    /**
     *
     * @ORM\OneToMany(targetEntity="Cliente", mappedBy="tipoIdentificacion")
     */
    private $clientes;
